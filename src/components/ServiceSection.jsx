...
const services = [
  {
    ...
    icon: 'https://i.ibb.co/D5q9rK3/web-development-programming-resized.jpg',
  ...
  },
  {
    ...
    icon: 'https://i.ibb.co/g95mCck/images-2.jpg', 
  ...
  },
  {
    ...
    icon: 'https://i.ibb.co/dcF9rS2/images-1.jpg', 
    animation: 'animate__fadeInUp', 
  },
  {
    ...
    icon: 'https://i.ibb.co/3NXn7kb/images-4.jpg', 
    animation: 'animate__fadeInUp', 
  },
];
  ...
  return (
    <section className="bg-gradient-to-r from-black via-purple-700 to-black py-16 px-6 md:px-12">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-3xl font-bold text-teal-400 mb-8">My Services</h2>
